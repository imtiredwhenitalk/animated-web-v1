...
const navigation = [
  ...
  { name: 'Pluto', element: <Link to="Pluto" /> },
  { name: 'Move to another planet', element: <Link to="Constellation" /> },
]
...
export default function Pluto() {
  ...
  return (
    <div className="bg-black min-h-screen">
      ...
      >
        <source src="/assets/pluto.mp4" type="video/mp4" />
      </video>
        ...
        <div className="relative isolate px-6 pt-14 lg:px-8 min-h-screen flex items-center">
          <div className="max-w-xl lg:max-w-2xl lg:ml-24 py-32 sm:py-48 lg:py-56">
            <h1 className="text-5xl font-semibold tracking-tight text-white sm:text-7xl leading-tight">
              Welcome to the{' '}
              <span className="text-red-900">Pluto</span>{' '}
              {' '}
              <span className="text-amber-900"></span>
            </h1>
            <p className="mt-8 text-lg font-medium text-gray-300 sm:text-xl/8">
              Pluto is the ninth planet from the Sun and the third-largest in the Solar System.
              It is a gas giant with a mass more than two and a half times that of all the other planets combined.
            </p>
            <div className="mt-10 flex items-center gap-x-6">
              <a
                href="#"
                className="rounded-md bg-red-950 px-4 py-2.5 text-sm font-semibold text-dark shadow hover:bg-red-800 transition-colors"
              >
                Learn more
              </a>
              <a
