...
const navigation = [
  ...
  { name: 'Move to another planet', element: <Link to="/uranus" /> },
]

export default function Saturn() {
  const [mobileMenuOpen, setMobileMenuOpen] = useState(false)
  const { t } = useLanguage()
  const copy = t.planets.pages.saturn

  const navItems = [
    { name: t.planets.ui.planets, to: '/planets' },
    { name: t.planets.ui.constellation, to: '/constellation' },
    { name: 'Saturn', to: '/saturn' },
    { name: t.planets.ui.moveToAnotherPlanet, to: '/uranus' },
  ]
